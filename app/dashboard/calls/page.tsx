                ...
                {/* Call Metadata */}
                 ...
                 {selectedCall.goal && (
                    <div className="border-t border-[#2A2A2A] pt-4">
                        ...
                        <p className="text-[#EDE7C7] bg-[#0A0A0A] p-3 rounded border border-[#2A2A2A] whitespace-pre-wrap">{selectedCall.goal}</p>
                    </div>
                 )}
                 ...
                 <div className="border-t border-[#2A2A2A] pt-4 space-y-2">
                     ...
                     <p className={`font-medium ${selectedCall.resulted_in_meeting ? 'text-green-500' : selectedCall.disqualification_reason ? 'text-red-500' : 'text-yellow-500'}`}>
                    ...
                    {selectedCall.disqualification_reason && (
                         <div>
                            ...
                            <p className="text-[#EDE7C7] mt-1 text-sm bg-[#0A0A0A] p-3 rounded border border-[#2A2A2A] whitespace-pre-wrap">{selectedCall.disqualification_reason}</p>
                        </div>
                    )}
                 </div>
